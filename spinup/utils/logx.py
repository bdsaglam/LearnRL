...
def suffix_for_pyt_save(itr=None):
    if itr is None:
        prefix = ''
    else:
        prefix = "_{:d}".format(itr)
    return prefix + '.pt'
...
class Logger:
    ...
    def setup_pytorch_saver(self, obj, name='model'):
        """
        ...
        Args:
            model: Any PyTorch model or serializable object containing
                PyTorch models.
        """
        self.pytorch_saver_elements[name] = obj
